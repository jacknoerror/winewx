...
public class ChatAllHistoryFragment extends Fragment {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
        ...
        //实例化popup标题栏按钮并设置监听
        titleBtn = (ImageView)getView().findViewById(R.id.iv_index_new_contact);
    ...
    /**
	  ...
	  public void initData(){
	    //给标题栏弹窗添加子类
	      titlePopup.addAction(new ActionItem(getActivity(), "添加好友", R.drawable.addfriend));
	      titlePopup.addAction(new ActionItem(getActivity(), "发起群聊", R.drawable.groupchars));
