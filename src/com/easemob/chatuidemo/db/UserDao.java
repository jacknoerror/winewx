...
public class UserDao {
	public static final String TABLE_NAME = "uers";  //用户表
	public static final String COLUMN_NAME_ID = "username";  //环信用户id
	public static final String COLUMN_NAME_NICK = "nick";  //用户昵称
	public static final String COLUMN_NAME_AVATAR = "avatar";  //头像
	public static final String COLUMN_MOBILE = "mobile";  //手机
	public static final String COLUMN_ADDRESS = "address";  //地址
	public static final String COLUMN_SIGN = "sign";  //签名
		...
		if (db.isOpen()) {
			...
			for (User user : contactList) {
				...
				if(user.getSign() != null)
				    values.put(COLUMN_SIGN, user.getSign());
